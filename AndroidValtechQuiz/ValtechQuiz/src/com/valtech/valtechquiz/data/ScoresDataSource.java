...
public class ScoresDataSource {
	...
	private String[] allColumns = { MySQLiteHelper.COLUMN_ID, MySQLiteHelper.COLUMN_SCORE, MySQLiteHelper.COLUMN_TIME, MySQLiteHelper.COLUMN_EMAIL, MySQLiteHelper.COLUMN_THEME};
	...
	public Score createScore(Score score) {
		...
		values.put(MySQLiteHelper.COLUMN_THEME, score.getTheme());
	...
	private Score cursorToScore(Cursor cursor) {
		...
		score.setTheme(cursor.getString(4));
		return score;
	}
}
